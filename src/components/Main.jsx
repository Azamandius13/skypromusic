      ...
      <div className="content__playlist playlist">
          ...
          <div className="playlist__track track">
            <div className="track__title">
              ...
              <div className="track__title-text">
                <a className="track__title-link" href="https://example.com">
                  Guilt <span className="track__title-span"></span>
                </a>
              </div>
            </div>
            <div className="track__author">
              <a className="track__author-link" href="https://example.com">
                Nero
              </a>
            </div>
            <div className="track__album">
              <a className="track__album-link" href="https://example.com">
                Welcome Reality
              </a>
            </div>
        ...
        <div className="playlist__item">
          <div className="playlist__track track">
            ...
            <div className="track__author">
              <a className="track__author-link" href="https://example.com"></a>
            </div>
            <div className="track__album">
              <a className="track__album-link" href="https://example.com"></a>
            </div>
            <div className="track__time">
              <svg className="track__time-svg" alt="time">
                <use href="img/icon/sprite.svg#icon-like"></use>
